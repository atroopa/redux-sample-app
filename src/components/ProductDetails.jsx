        ...
        <div className="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
            ...
            <form action method="post">
                ...
                <div className="w-full flex flex-col mt-8">
                    ...
                    <textarea type="text" className="h-40 text-base leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-800 border-0 rounded" defaultValue={""} />
                </div>
                </div>
